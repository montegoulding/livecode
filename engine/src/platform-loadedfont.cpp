...
void MCPlatformLoadedFontRetain(MCPlatformLoadedFontRef p_loaded_font)
{
    p_loaded_font->Retain();
}

void MCPlatformLoadedFontRelease(MCPlatformLoadedFontRef p_loaded_font)
{
