...
//
//void MCPlatformHandleDragEnter(MCPlatformWindowRef window, MCPlatformClipboardRef p_clipboard, MCPlatformDragOperation& r_operation) { return; }
...
//bool MCRegionSetEmpty(MCRegionRef) { return false;}
